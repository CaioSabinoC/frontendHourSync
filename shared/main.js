...
/* =====================================================
   SIDEBAR — Preencher usuário logado automaticamente
   ===================================================== */
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (imgEl) {
    imgEl.src = u.fotoUrl || `https://ui-avatars.com/api/?background=6c83e6&color=fff&name=${encodeURIComponent(u.nome)}`;
    imgEl.alt = u.nome;
  }
});
